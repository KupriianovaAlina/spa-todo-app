const initialState = {
  ...
  tasks: [
    ...
    { name: 'Develop and launch a website', description: 'The easiest part, I bet you', projectId: '1', id: '4', status: 'queue', date: '10.09.2023' },
    ...
    { name: 'Make a figure', description: 'It may be difficult, but it will definitely be a lot of fun', projectId: '2', id: '7', status: 'queue', date: '18.09.2023' },
    { name: 'Understand what CRM systems are', description: 'Just read some books: "Beyond CRM Basics: An MVP Guide to Expand Your Knowledge and Grow Your Career", "CRM For Dummies" and "The Customer Centricity Playbook: Implement a Winning Strategy Driven by Customer Lifetime Value"', projectId: '3', id: '8', status: 'queue', date: '01.09.2023' },
